Display displayFromJson(Map<String, dynamic> json) =>
    Display(a: json['a'], b: json['b'], c: json['c'], d: json['d']);
...
class Display {
  ...
  ///
  /// See [FLAG_SUPPORTS_PROTECTED_BUFFERS], [flagSecure], [flagPrivate]
  String? b;
  ...
  Display({required this.a, this.b, required this.c, this.d});
}
