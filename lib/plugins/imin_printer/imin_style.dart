...
class LabelAreaStyle {
  ...
  factory LabelAreaStyle.fromMap(Map<String, dynamic> map) {
    return LabelAreaStyle(
      style: Shape.values.firstWhere(
        (e) => e.toString() == 'Shape.${map['style']}',
      ),
      width: map['width'],
      height: map['height'],
      posX: map['posX'],
...
class LabelBarCodeStyle {
  ...
  factory LabelBarCodeStyle.fromMap(Map<String, dynamic> map) {
    return LabelBarCodeStyle(
      ...
      symbology: Symbology.values.firstWhere(
        (e) => e.toString() == 'Symbology.${map['symbology']}',
      ),
      align: AlignLabel.values.firstWhere(
        (e) => e.toString() == 'AlignLabel.${map['align']}',
      ),
      rotate: Rotate.values.firstWhere(
        (e) => e.toString() == 'Rotate.${map['rotate']}',
      ),
      width: map['width'],
      height: map['height'],
    );
...
class LabelQrCodeStyle {
  ...
  factory LabelQrCodeStyle.fromMap(Map<String, dynamic> map) {
    return LabelQrCodeStyle(
      ...
      posY: map['posY'],
      size: map['size'],
      errorLevel: ErrorLevel.values.firstWhere(
        (e) => e.toString() == 'ErrorLevel.${map['errorLevel']}',
      ),
      rotate: Rotate.values.firstWhere(
        (e) => e.toString() == 'Rotate.${map['rotate']}',
      ),
...
class LabelPrintBitmapStyle {
  ...
  factory LabelPrintBitmapStyle.fromMap(Map<String, dynamic> map) {
    return LabelPrintBitmapStyle(width: map['width'], height: map['height']);
  }
}
