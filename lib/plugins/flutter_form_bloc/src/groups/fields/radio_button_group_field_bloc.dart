...
import 'package:mts/plugins/flutter_form_bloc/src/features/appear/can_show_field_bloc_builder.dart';
import 'package:mts/plugins/flutter_form_bloc/src/groups/widgets/group_view.dart';
import 'package:mts/plugins/flutter_form_bloc/src/groups/widgets/item_group_tile.dart';
import 'package:mts/plugins/flutter_form_bloc/src/theme/field_theme_resolver.dart';
import 'package:mts/plugins/flutter_form_bloc/src/theme/form_bloc_theme.dart';
import 'package:mts/plugins/flutter_form_bloc/src/utils/utils.dart';
import 'package:mts/plugins/form_bloc/form_bloc.dart';
      ...
      child: GroupView(
        ...
        builder: (context, index) {
          ...
          return ItemGroupTile(
            ...
            onTap:
                fieldTheme.canTapItemTile && onChanged != null
                    ? () => onChanged(
