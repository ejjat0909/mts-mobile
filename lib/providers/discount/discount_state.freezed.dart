...
mixin _$DiscountState {
  List<DiscountModel> get items => throw _privateConstructorUsedError;
...
abstract class $DiscountStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<DiscountModel> items, String? error, bool isLoading});
}
...
class _$DiscountStateImpl implements _DiscountState {
  const _$DiscountStateImpl(
      {final List<DiscountModel> items = const [],
      this.error,
      this.isLoading = false})
      : _items = items;

  final List<DiscountModel> _items;
  @override
  @JsonKey()
  List<DiscountModel> get items {
  ...
  @override
  String toString() {
    return 'DiscountState(items: $items, error: $error, isLoading: $isLoading)';
  }
...
abstract class _DiscountState implements DiscountState {
  const factory _DiscountState(
      {final List<DiscountModel> items,
      final String? error,
      final bool isLoading}) = _$DiscountStateImpl;
