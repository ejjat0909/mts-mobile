...
/// @nodoc
mixin _$StaffState {
  List<StaffModel> get items => throw _privateConstructorUsedError;
...
abstract class $StaffStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<StaffModel> items, String? error, bool isLoading});
}
...
class _$StaffStateImpl implements _StaffState {
  const _$StaffStateImpl(
      {final List<StaffModel> items = const [],
      this.error,
      this.isLoading = false})
      : _items = items;

  final List<StaffModel> _items;
  @override
  @JsonKey()
  List<StaffModel> get items {
  ...
  @override
  String toString() {
    return 'StaffState(items: $items, error: $error, isLoading: $isLoading)';
  }
