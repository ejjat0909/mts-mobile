...
/// @nodoc
mixin _$DeviceState {
  List<PosDeviceModel> get items => throw _privateConstructorUsedError;
...
abstract class $DeviceStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PosDeviceModel> items, String? error, bool isLoading});
}
...
class _$DeviceStateImpl implements _DeviceState {
  const _$DeviceStateImpl(
      {final List<PosDeviceModel> items = const [],
      this.error,
      this.isLoading = false})
      : _items = items;

  final List<PosDeviceModel> _items;
  @override
  @JsonKey()
  List<PosDeviceModel> get items {
  ...
  @override
  String toString() {
    return 'DeviceState(items: $items, error: $error, isLoading: $isLoading)';
  }
...
abstract class _DeviceState implements DeviceState {
  const factory _DeviceState(
      {final List<PosDeviceModel> items,
      final String? error,
      final bool isLoading}) = _$DeviceStateImpl;
