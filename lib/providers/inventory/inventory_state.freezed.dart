...
mixin _$InventoryState {
  List<InventoryModel> get items => throw _privateConstructorUsedError;
...
abstract class $InventoryStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<InventoryModel> items, String? error, bool isLoading});
}
...
class _$InventoryStateImpl implements _InventoryState {
  const _$InventoryStateImpl(
      {final List<InventoryModel> items = const [],
      this.error,
  ...
  @override
  String toString() {
    return 'InventoryState(items: $items, error: $error, isLoading: $isLoading)';
  }
...
abstract class _InventoryState implements InventoryState {
  const factory _InventoryState(
      ...
      final String? error,
      final bool isLoading}) = _$InventoryStateImpl;
