...
class SaleListResponseModel extends BaseAPIResponse<List<SaleModel>, void> {
  SaleListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SaleModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SaleModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SaleModel.fromJson(v));
      });
