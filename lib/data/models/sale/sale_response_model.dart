...
class SaleResponseModel extends BaseAPIResponse<SaleModel, void> {
  SaleResponseModel(super.fullJson);

  @override
  Map<String, dynamic>? dataToJson(SaleModel? data) {
    if (this.data != null) {
  ...
  @override
  SaleModel? jsonToData(Map<String, dynamic>? json) {
    return json!['data'] != null ? SaleModel.fromJson(json['data']) : null;
  }
