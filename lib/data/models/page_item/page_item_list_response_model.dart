...
class PageItemListResponseModel
    extends BaseAPIResponse<List<PageItemModel>, void> {
  PageItemListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PageItemModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PageItemModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PageItemModel.fromJson(v));
      });
