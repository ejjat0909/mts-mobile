...
class CategoryListResponseModel
    extends BaseAPIResponse<List<CategoryModel>, void> {
  CategoryListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<CategoryModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<CategoryModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];
