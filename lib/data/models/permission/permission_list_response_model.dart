...
class PermissionListResponseModel
    extends BaseAPIResponse<List<PermissionModel>, void> {
  PermissionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PermissionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PermissionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PermissionModel.fromJson(v));
      });
