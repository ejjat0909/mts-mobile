...
class OrderOptionListResponseModel
    extends BaseAPIResponse<List<OrderOptionModel>, void> {
  OrderOptionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<OrderOptionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<OrderOptionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(OrderOptionModel.fromJson(v));
      });
