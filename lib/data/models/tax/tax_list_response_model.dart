...
class TaxListResponseModel extends BaseAPIResponse<List<TaxModel>, void> {
  TaxListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<TaxModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<TaxModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];
