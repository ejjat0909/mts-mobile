...
class PrinterSettingListResponseModel
    extends BaseAPIResponse<List<PrinterSettingModel>, void> {
  PrinterSettingListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PrinterSettingModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PrinterSettingModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PrinterSettingModel.fromJson(v));
      });
