...
class ItemModifierListResponseModel
    extends BaseAPIResponse<List<ItemModifierModel>, void> {
  ItemModifierListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ItemModifierModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ItemModifierModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ItemModifierModel.fromJson(v));
      });
