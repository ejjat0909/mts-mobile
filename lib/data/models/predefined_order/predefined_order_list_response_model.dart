...
class PredefinedOrderListResponseModel
    extends BaseAPIResponse<List<PredefinedOrderModel>, void> {
  PredefinedOrderListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PredefinedOrderModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PredefinedOrderModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PredefinedOrderModel.fromJson(v));
      });
