...
class OrderOptionTaxListResponseModel
    extends BaseAPIResponse<List<OrderOptionTaxModel>, void> {
  OrderOptionTaxListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<OrderOptionTaxModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<OrderOptionTaxModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(OrderOptionTaxModel.fromJson(v));
      });
