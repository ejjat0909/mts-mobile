...
class OutletListResponseModel extends BaseAPIResponse<List<OutletModel>, void> {
  OutletListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<OutletModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<OutletModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(OutletModel.fromJson(v));
      });
