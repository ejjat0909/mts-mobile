...
class SaleModifierListResponseModel
    extends BaseAPIResponse<List<SaleModifierModel>, void> {
  SaleModifierListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SaleModifierModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SaleModifierModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SaleModifierModel.fromJson(v));
      });
