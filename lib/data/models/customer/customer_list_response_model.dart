...
class CustomerListResponseModel
    extends BaseAPIResponse<List<CustomerModel>, void> {
  CustomerListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<CustomerModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<CustomerModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];
