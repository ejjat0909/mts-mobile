...
class FeatureCompanyListResponseModel
    extends BaseAPIResponse<List<FeatureCompanyModel>, void> {
  FeatureCompanyListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<FeatureCompanyModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<FeatureCompanyModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(FeatureCompanyModel.fromJson(v));
      });
