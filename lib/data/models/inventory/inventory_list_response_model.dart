...
class InventoryListResponseModel
    extends BaseAPIResponse<List<InventoryModel>, void> {
  InventoryListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<InventoryModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<InventoryModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(InventoryModel.fromJson(v));
      });
