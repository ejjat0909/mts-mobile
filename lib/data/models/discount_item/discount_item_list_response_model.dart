...
class DiscountItemListResponseModel
    extends BaseAPIResponse<List<DiscountItemModel>, void> {
  DiscountItemListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<DiscountItemModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<DiscountItemModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(DiscountItemModel.fromJson(v));
      });
