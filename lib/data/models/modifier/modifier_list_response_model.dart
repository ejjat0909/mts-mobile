...
class ModifierListResponseModel
    extends BaseAPIResponse<List<ModifierModel>, void> {
  ModifierListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ModifierModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ModifierModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ModifierModel.fromJson(v));
      });
