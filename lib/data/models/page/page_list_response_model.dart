...
class PageListResponseModel extends BaseAPIResponse<List<PageModel>, void> {
  PageListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PageModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PageModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PageModel.fromJson(v));
      });
