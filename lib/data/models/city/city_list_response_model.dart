...
class CityListResponseModel extends BaseAPIResponse<List<CityModel>, void> {
  CityListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<CityModel>? data) {
    if (this.data != null) {
