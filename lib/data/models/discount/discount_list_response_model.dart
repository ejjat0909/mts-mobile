...
class DiscountListResponseModel
    extends BaseAPIResponse<List<DiscountModel>, void> {
  DiscountListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<DiscountModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<DiscountModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(DiscountModel.fromJson(v));
      });
