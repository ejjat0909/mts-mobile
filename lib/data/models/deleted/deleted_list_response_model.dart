...
class DeletedListResponseModel
    extends BaseAPIResponse<List<DeletedModel>, void> {
  DeletedListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<DeletedModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<DeletedModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(DeletedModel.fromJson(v));
      });
