...
class SlideshowListResponseModel
    extends BaseAPIResponse<List<SlideshowModel>, void> {
  SlideshowListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SlideshowModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SlideshowModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SlideshowModel.fromJson(v));
      });
