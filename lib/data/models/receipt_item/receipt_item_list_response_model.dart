...
class ReceiptItemListResponseModel
    extends BaseAPIResponse<List<ReceiptItemModel>, void> {
  ReceiptItemListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ReceiptItemModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ReceiptItemModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ReceiptItemModel.fromJson(v));
      });
