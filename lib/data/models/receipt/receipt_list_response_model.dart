...
class ReceiptListResponseModel
    extends BaseAPIResponse<List<ReceiptModel>, void> {
  ReceiptListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ReceiptModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ReceiptModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];
