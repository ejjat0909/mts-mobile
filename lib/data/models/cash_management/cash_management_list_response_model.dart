...
class CashManagementListResponseModel
    extends BaseAPIResponse<List<CashManagementModel>, void> {
  CashManagementListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<CashManagementModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<CashManagementModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(CashManagementModel.fromJson(v));
      });
