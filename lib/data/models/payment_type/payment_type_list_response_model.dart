...
class PaymentTypeListResponseModel
    extends BaseAPIResponse<List<PaymentTypeModel>, void> {
  PaymentTypeListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PaymentTypeModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PaymentTypeModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PaymentTypeModel.fromJson(v));
      });
