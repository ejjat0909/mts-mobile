...
class ItemTaxListResponseModel
    extends BaseAPIResponse<List<ItemTaxModel>, void> {
  ItemTaxListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ItemTaxModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ItemTaxModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ItemTaxModel.fromJson(v));
      });
