...
class UserListResponseModel extends BaseAPIResponse<List<UserModel>, void> {
  UserListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<UserModel>? data) {
    if (this.data != null) {
