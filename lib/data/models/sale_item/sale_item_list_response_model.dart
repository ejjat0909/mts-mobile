...
class SaleItemListResponseModel
    extends BaseAPIResponse<List<SaleItemModel>, void> {
  SaleItemListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SaleItemModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SaleItemModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SaleItemModel.fromJson(v));
      });
