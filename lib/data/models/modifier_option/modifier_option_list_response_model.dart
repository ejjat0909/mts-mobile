...
class ModifierOptionListResponseModel
    extends BaseAPIResponse<List<ModifierOptionModel>, void> {
  ModifierOptionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ModifierOptionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ModifierOptionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ModifierOptionModel.fromJson(v));
      });
