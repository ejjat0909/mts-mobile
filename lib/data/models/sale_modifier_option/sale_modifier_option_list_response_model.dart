...
class SaleModifierOptionListResponseModel
    extends BaseAPIResponse<List<SaleModifierOptionModel>, void> {
  SaleModifierOptionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SaleModifierOptionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SaleModifierOptionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SaleModifierOptionModel.fromJson(v));
      });
