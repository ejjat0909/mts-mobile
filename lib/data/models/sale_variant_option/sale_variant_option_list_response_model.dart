...
class SaleVariantOptionListResponseModel
    extends BaseAPIResponse<List<SaleVariantOptionModel>, void> {
  SaleVariantOptionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<SaleVariantOptionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<SaleVariantOptionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(SaleVariantOptionModel.fromJson(v));
      });
