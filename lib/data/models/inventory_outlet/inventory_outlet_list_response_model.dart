...
class InventoryOutletListResponseModel
    extends BaseAPIResponse<List<InventoryOutletModel>, void> {
  InventoryOutletListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<InventoryOutletModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<InventoryOutletModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(InventoryOutletModel.fromJson(v));
      });
