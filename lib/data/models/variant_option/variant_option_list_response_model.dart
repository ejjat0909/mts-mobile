...
class VariantOptionListResponseModel
    extends BaseAPIResponse<List<VariantOptionModel>, void> {
  VariantOptionListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<VariantOptionModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<VariantOptionModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(VariantOptionModel.fromJson(v));
      });
