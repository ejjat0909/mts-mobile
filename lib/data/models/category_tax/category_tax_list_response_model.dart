...
class CategoryTaxListResponseModel
    extends BaseAPIResponse<List<CategoryTaxModel>, void> {
  CategoryTaxListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<CategoryTaxModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<CategoryTaxModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(CategoryTaxModel.fromJson(v));
      });
