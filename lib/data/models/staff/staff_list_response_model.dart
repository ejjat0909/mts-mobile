...
class StaffListResponseModel extends BaseAPIResponse<List<StaffModel>, void> {
  StaffListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<StaffModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<StaffModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];
