...
class PosDeviceListResponseModel
    extends BaseAPIResponse<List<PosDeviceModel>, void> {
  PosDeviceListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PosDeviceModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PosDeviceModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PosDeviceModel.fromJson(v));
      });
