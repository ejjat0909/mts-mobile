...
class TimeCardListResponseModel
    extends BaseAPIResponse<List<TimecardModel>, void> {
  TimeCardListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<TimecardModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<TimecardModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(TimecardModel.fromJson(v));
      });
