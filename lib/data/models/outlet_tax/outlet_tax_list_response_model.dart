...
class OutletTaxListResponseModel
    extends BaseAPIResponse<List<OutletTaxModel>, void> {
  OutletTaxListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<OutletTaxModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<OutletTaxModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(OutletTaxModel.fromJson(v));
      });
