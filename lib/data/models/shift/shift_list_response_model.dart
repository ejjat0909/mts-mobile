...
class ShiftListResponseModel extends BaseAPIResponse<List<ShiftModel>, void> {
  ShiftListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<ShiftModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<ShiftModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(ShiftModel.fromJson(v));
      });
