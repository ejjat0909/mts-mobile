...
class PrintingLogListResponseModel
    extends BaseAPIResponse<List<PrintingLogModel>, void> {
  PrintingLogListResponseModel(super.fullJson);

  @override
  List<Map<String, dynamic>>? dataToJson(List<PrintingLogModel>? data) {
    if (this.data != null) {
  ...
  @override
  List<PrintingLogModel>? jsonToData(Map<String, dynamic>? json) {
    if (json != null) {
      data = [];

      json['data'].forEach((v) {
        data!.add(PrintingLogModel.fromJson(v));
      });
